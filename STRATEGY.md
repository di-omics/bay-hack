...
| **Credibility** | `plr-tested` (liquid handler, real) + `benchmarks`/`omics-demos` | You don't just sim — you've run it, and you score everything against planted ground truth. |
...
| Relevance / impact | Trust is the actual blocker for autonomous labs; you have liquid handler-validated cred. |
